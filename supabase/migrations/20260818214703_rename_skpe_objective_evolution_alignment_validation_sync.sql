create or replace function public.sync_skpe_obj_evol_alignment_validation()
returns trigger
language plpgsql
security definer
set search_path = ''
...
revoke execute
on function public.sync_skpe_obj_evol_alignment_validation()
from public;
...
execute function public.sync_skpe_obj_evol_alignment_validation();

drop function if exists
public.sync_skpe_objective_evolution_alignment_validation_with_scenari();